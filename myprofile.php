...
<html>
<head>
  <title>My Profile | 66-APMS</title>
  <!-- Icons font CSS-->
                    ...
                    <form method="POST" action="myprofileup.php?id=<?php echo $id?>" >
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                  <p>Service ID</p>
                                    <input class="input--style-1" type="number" name="service_idservice_id" value="<?php echo $service_idservice_id;?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                  <p>Marital Status</p>
                                     <input class="input--style-1" type="text" name="status" value="<?php echo $status;?>" readonly >
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                         ...
                         <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                  <p>Battery</p>
                                     <input class="input--style-1" type="text" name="battery" value="<?php echo $battery;?>" readonly >
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                  <p>Rank</p>
                                    <input class="input--style-1" type="text"  name="rank" value="<?php echo $rank;?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                          <p>JHS Attended</p>
                            <input class="input--style-1" type="text" name="jhs" value="<?php echo $jhs;?>" readonly>
                        </div>

                        <div class="input-group">
                          <p>SHS Attended</p>
                            <input class="input--style-1" type="text" name="shs" value="<?php echo $shs;?>" readonly>
                        </div>


                        <div class="input-group">
                          <p>Tertiary Attended</p>
                            <input class="input--style-1" type="text" name="tertiary" value="<?php echo $tertiary;?>" readonly>
                        </div>
