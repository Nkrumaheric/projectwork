...
<html>
<head>
	<title>Admin Panel | 66-APMS</title>
...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="addemp.php">Add Personel</a></li>
	...
	<div id="divimg">
		<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">Personel Leaderboard </h2>
    	<table>
