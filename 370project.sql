...
INSERT INTO `employee` (`id`, `firstName`, `lastName`, `email`, `password`, `contact`, `service_id`, `birthday`, `gender`, `status`, `address`, `battery`, `rank`, `jhs`, `shs`, `tertiary`, `pic`) VALUES
(101, 'Test', 'Pilot', 'testpilot@gmail.com', '1234', '0240005000', '1121', '2018-01-01', 'Male', 'single', 'Ad_______', 'bravo', 'colonel', 'EP-primary', 'Mawuli', 'HTU', 'images/no.jpg'),
(102, 'Elon', 'Musk', 'elon@gmail.com', '1234', '0230004000', '1122', '1971-06-28', 'Male', 'married', 'USA', 'H.Q', 'major', 'poly-primary', 'Spaco', 'HTU', 'images/330px-Elon_Musk_Royal_Society.jpg'),
(103, 'Jon', 'Snow', 'john@gmail.com', '1234', '0550000900', '1123', '2011-02-01', 'Male', 'single', 'Winterfell',  'Charlie','W.O II', 'Pomo-primary', 'st. John', 'HTU', 'images/jon-snow.jpg');
...
--
ALTER TABLE `employee_leave`
  ADD CONSTRAINT `employee_leave_ibfk_1` FOREIGN KEY (`eid`) REFERENCES `employee` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
